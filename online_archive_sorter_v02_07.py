...
# ===== ADDED: FIX FOR WINDOWS CONSOLE ENCODING =====
# Add this at the beginning to fix Windows console encoding
if sys.platform == "win32":
    ...
    # Also set the environment variable for additional safety
...
class OnlineArchiveSorter:
    ...
    def setup_logging(self):
        # Modified to include UTF-8 encoding
    ...
    def _create_logger(self, name, log_file):
        ...
        try:
            ...
            # Also add console handler for real-time feedback with UTF-8
            ...
            # Fallback to basic setup without encoding if there's an error
